-- Add budget_item to allowed entity types in change_logs
...
-- Attach trigger to budget_items table
DROP TRIGGER IF EXISTS log_budget_item_changes_trigger ON public.budget_items;

CREATE TRIGGER log_budget_item_changes_trigger
