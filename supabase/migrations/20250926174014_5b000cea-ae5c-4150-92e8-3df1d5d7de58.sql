...
CREATE INDEX idx_hospitality_profiles_business_name ON public.hospitality_profiles(business_name);
CREATE INDEX idx_hospitality_profiles_city_state ON public.hospitality_profiles(city, state);
CREATE INDEX idx_hospitality_profile_amenities_profile_id ON public.hospitality_profile_amenities(hospitality_profile_id);
CREATE INDEX idx_hospitality_profile_amenities_amenity_id ON public.hospitality_profile_amenities(amenity_type_id);